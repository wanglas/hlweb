...
*/
(function(win) {
	var root = ROOT_PATH + '/Public/' || location.origin + '/Public/',
		ver = '',
		//定义常用JS组件别名，使用别名加载
		alias = {
            ...
            iframeTools       : 'js/artDialog/plugins/iframeTools',
			swfupload         : 'js/swfupload/swfupload'
		},
        //CSS路径
		alias_css = {
            colorPicker : 'colorPicker/style',
            artDialog   : 'js/artDialog/skins/aero',
	...
	head.css = function(alias/*alias or path*/,callback) {
