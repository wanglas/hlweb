            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form action="<?php echo U('Goods/index');?>" role="form" class="form-inline" method="post">
                            <div class="form-group">
                            <label for="exampleInputEmail2" class="sr-only">商品名称</label>
                            <input type="text" placeholder="商品名称"  name="name" value="" class="form-control">
                            </div>
                    ...
                    <div class="ibox-title">
                        <h5>
                            <div class="btn btn-success">
                              <a href="<?php echo U('Goods/add');?>" style="color:white;"><span class="bold">新增</span></a>
                            </div>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                ...
                                <td><?php if ($vo[status]==1){echo '上架';} if ($vo[status]==0) {echo '下架';} ?></td>
                                <!-- <td><?php if($vo[status] == 1): ?>启用<else condition="$vo[status] eq 0" />禁用<?php endif; ?> </td> -->
                                <!-- 用[] -->
                                <td ><img style="width:80px;height:90px;"src="/hlweb/Uploads/<?php echo ($vo["img"]); ?>" alt="<?php echo ($vo["name"]); ?>"></td>
                                <td>
                                    <a href="<?php echo U('Goods/edit',array('id'=>$vo[id]));?>">编辑</a>&nbsp;&nbsp;
                                    <a href="<?php echo U('Goods/delete',array('id'=>$vo[id]));?>">删除</a>
                                </td>
