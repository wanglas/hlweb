...
<!--
//指定当前组模块URL地址
var URL = '/hlweb/index.php/Admin/Employ';var PUBLIC = '/hlweb/Public';var ROOT_PATH = '/hlweb';var APP = '/hlweb/index.php'+'/'+'<?php echo ($group_name); ?>';var STATIC = '__TMPL__Static';
