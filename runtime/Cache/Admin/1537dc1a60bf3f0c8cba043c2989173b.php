...
<!--
//指定当前组模块URL地址
var URL = '/hlweb/index.php/Admin/Cate';var PUBLIC = '/hlweb/Public';var ROOT_PATH = '/hlweb';var APP = '/hlweb/index.php'+'/'+'<?php echo ($group_name); ?>';var STATIC = '__TMPL__Static';
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form action="" role="form" class="form-inline" method="get">
                            ...
                            <input type="text" placeholder="商品类型"  name="name" value="<?php echo ($name); ?>" class="form-control">
                            </div>
                    ...
                    <div class="ibox-title">
                        <h5>
                            <div class="btn btn-success">
                              <a href="<?php echo U('Cate/add');?>" style="color:white;"><span class="bold">新增</span></a>
                            </div>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                ...
                                <!-- 用[] -->
                                <td>
                                    <a href="<?php echo U('Cate/edit',array('id'=>$vo[id]));?>">编辑</a>&nbsp;&nbsp;
                                    <a href="<?php echo U('Cate/delete',array('id'=>$vo[id]));?>">删除</a>
                                </td>
