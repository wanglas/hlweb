...
<!--
//指定当前组模块URL地址
var URL = '/hlweb/index.php/Admin/Adv';var PUBLIC = '/hlweb/Public';var ROOT_PATH = '/hlweb';var APP = '/hlweb/index.php'+'/'+'<?php echo ($group_name); ?>';var STATIC = '__TMPL__Static';
                    ...
                    <div class="ibox-title">
                        <h5>
                            <div class="btn btn-success">
                              <a href="<?php echo U('Adv/add');?>" style="color:white;"><span class="bold">新增</span></a>
                            </div>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                ...
                                <td ><img style="width:80px;height:60px;"src="/hlweb/Uploads/<?php echo ($vo["img"]); ?>" alt="<?php echo ($vo["name"]); ?>"></td>
                                ...
                                <!-- 用[] -->
                                <td>
                                    <a href="<?php echo U('Adv/edit',array('id'=>$vo[id]));?>">编辑</a>&nbsp;&nbsp;
                                    <a href="<?php echo U('Adv/delete',array('id'=>$vo[id]));?>">删除</a>
                                </td>
