...
<!--
//指定当前组模块URL地址
var URL = '/hlweb/index.php/Admin/Supplier';var PUBLIC = '/hlweb/Public';var ROOT_PATH = '/hlweb';var APP = '/hlweb/index.php'+'/'+'<?php echo ($group_name); ?>';var STATIC = '__TMPL__Static';
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form action="<?php echo U('Supplier/index');?>" role="form" class="form-inline" method="post">
                            <div class="form-group">
                            <label for="exampleInputEmail2" class="sr-only">公司名称</label>
                            <input type="text" placeholder="公司名称"  name="name" value="" class="form-control">
                            </div>
                    ...
                    <div class="ibox-title">
                        <h5>
                            <div class="btn btn-success">
                              <a href="<?php echo U('Supplier/add');?>" style="color:white;"><span class="bold">新增</span></a>
                            </div>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                ...
                                <!-- 用[] -->
                                <td>
                                    <a href="<?php echo U('Supplier/edit',array('id'=>$vo[id]));?>">编辑</a>&nbsp;&nbsp;
                                    <a href="<?php echo U('Supplier/delete',array('id'=>$vo[id]));?>">删除</a>
                                </td>
