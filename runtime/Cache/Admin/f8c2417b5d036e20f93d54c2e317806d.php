...
<!--
//指定当前组模块URL地址
var URL = '/hlweb/index.php/Admin/City';var PUBLIC = '/hlweb/Public';var ROOT_PATH = '/hlweb';var APP = '/hlweb/index.php'+'/'+'<?php echo ($group_name); ?>';var STATIC = '__TMPL__Static';
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form action="<?php echo U('City/index');?>" role="form" class="form-inline" method="get">
                            <div class="form-group">
                            <label for="exampleInputEmail2" class="sr-only">城市</label>
                            <input type="text" placeholder="城市名称"  name="name" value="<?php echo ($name); ?>" class="form-control">
                            </div>
                    ...
                    <div class="ibox-title">
                        <h5>
                            <div class="btn btn-success">
                              <a href="<?php echo U('city/add');?>" style="color:white;"><span class="bold">新增</span></a>
                            </div>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                ...
                                <!-- 用[] -->
                                <td>
                                    <a href="<?php echo U('city/edit',array('id'=>$vo[id]));?>">编辑</a>&nbsp;&nbsp;
                                    <a href="<?php echo U('city/delete',array('id'=>$vo[id]));?>">删除</a>
                                </td>
