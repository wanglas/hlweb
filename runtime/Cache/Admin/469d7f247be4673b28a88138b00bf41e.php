...
<!--
//指定当前组模块URL地址
var URL = '/hlweb/index.php/Admin/Db';var PUBLIC = '/hlweb/Public';var ROOT_PATH = '/hlweb';var APP = '/hlweb/index.php'+'/'+'<?php echo ($group_name); ?>';var STATIC = '__TMPL__Static';
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      <div class="btn btn-w-m btn-success">
                        <a href="<?php echo U('Db/db_backup');?>" style="color:white;">数据库备份</a>
                      </div>
                      <p>(mysql有密码就可以实现)</p>
                    </div>
                </div>
